...
navigation_clue_sets: array of EXACTLY 32 ranked clue sets, each {class_name, correct_object, decoy_objects}. These are used as physical objects placed in front of the four archways so the player can infer which way leads toward the goal.
  Choose class_name from this list, or a more specific subtype if it clearly belongs to one of these classes: tools, vehicles, animals, portraits, equations, chemical elements, books, musical instruments, hats, weapons, landmarks, flags, masks, mythological creatures, astronomical objects, robots, sports equipment, weather phenomena, road signs, organs, tarot cards, dwellings, timepieces, trees, sea creatures, constellations, coins, furniture, footwear, toys, gadgets, maps.
